...
export const GLOBAL_SET_SERVER_NAME = "setServer";
...
// client request config keys
export const CONFIG_METHOD_KEY = "method";
export const CONFIG_PATH_KEY = "paths";
...
export const GEN_CONFIG_FILE_NAME = ".openapi-fetch.json";
